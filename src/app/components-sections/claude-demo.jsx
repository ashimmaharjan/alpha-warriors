    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          <div className="mb-8">
            <h1 className="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-r from-red-500 via-yellow-500 to-cyan-400 bg-clip-text text-transparent animate-pulse">
              ALPHA WARRIORS
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8">
              Dominating Indoor Cricket in Nepal
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
                Join Our Team
                <ChevronRight className="ml-2 w-5 h-5" />
              </button>
              <button className="border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-gray-900 px-8 py-4 rounded-full font-semibold transition-all duration-300">
                Watch Highlights
              </button>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="bg-gradient-to-br from-gray-700 to-gray-800 p-6 rounded-2xl shadow-xl">
            ...
            <div className="bg-gradient-to-br from-gray-700 to-gray-800 p-6 rounded-2xl shadow-xl">
              <div className="text-4xl font-bold text-green-400 mb-2">2018</div>
